...
export const ServerDataWarningModal = ({open, title = "Warning", message, retryInterval = 5, onRetry }: WarningModalProps) => {
                ...
                <ModalFooter>
                    {isRetrying ? (
                        <div className="mt-4 flex justify-center">
                            <div
                                className="animate-spin h-6 w-6 border-4 border-gray-300 border-t-blue-600 rounded-full"></div>
                        </div>
                    ) : (
